...
extern int extract_focal_length(const char* filename, float* focal_length, float ccd_width);

#define FOCAL_LENGTH_OK           0
#define FOCAL_LENGTH_INVALID_EXIF 2
#define FOCAL_LENGTH_NO_CCD_DATA  3
