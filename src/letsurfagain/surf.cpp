...
void Surf::getDescriptor(bool bUpright)
{
  ...
  float dxUp0, dxUnd0, dyUnd0, dyUp0, dxModUp0, dxModUnd0, dyModUnd0, dyModUp0;
  ...
  while(i < 12)
  {
    ...
    {
      dx=dy=mdx=mdy=0.f;
      dxUp0=dxUnd0=dyUnd0=dyUp0=dxModUp0=dxModUnd0=dyModUnd0=dyModUp0=0.f;
      cy += 1.f;
      ...
      desc[count++] = dxUp0*gauss_s2;
      desc[count++] = dxModUp0*gauss_s2;
      desc[count++] = dyUp0*gauss_s2;
      desc[count++] = dyModUp0*gauss_s2;
      desc[count++] = dxUnd0*gauss_s2;
      desc[count++] = dxModUnd0*gauss_s2;
      desc[count++] = dyUnd0*gauss_s2;
      desc[count++] = dyModUnd0*gauss_s2;
